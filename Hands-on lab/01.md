...
Refer to the [Before the hands-on lab setup guide manual](https://github.com/microsoft/MCW-Machine-Learning/blob/master/Hands-on%20lab/Before%20the%20HOL%20-%20Machine%20Learning.md) before continuing to the lab exercises.

   > The prerequisites are already perfomed in the environement, no need to perform any tasks from Before the hands-on lab. 
