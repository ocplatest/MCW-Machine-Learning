...
2.After Launching , you will be asked to select subscription and AMchine learning workspace . select subscription name starting with **Azure Labs** and select machine learning workspace name starting with **AML-workspace-XXXXXX**  
